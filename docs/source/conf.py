...
# ones.
extensions = [
    'sphinx.ext.githubpages','rst2pdf.pdfbuilder',
]
...
pdf_documents = [('index', u'documentation', u'ITUCSDB1964', u'Zeynep GÜRLER and Fatih TELOĞLU'),]
